...
public class UserController extends BaseFormController{
    ...
    public ModelAndView view(@PathVariable String libraryPath,HttpServletRequest request)throws Exception {
    ...
    public ModelAndView edit(@PathVariable String libraryPath)throws Exception {
    	Model model = new ExtendedModelMap();
    	super.libraryAndPropertyPass(model, DM_FORM_NAME, libraryPath);
    ...
    public ModelAndView changePassword(@PathVariable String libraryPath)throws Exception {
    	Model model = new ExtendedModelMap();
    	super.libraryAndPropertyPass(model, DM_FORM_NAME, libraryPath);
    	model.addAttribute("formEditFlag", true);   
    ...
    public ModelAndView onSubmit(@PathVariable String libraryPath,AuthAppUser authAppUser,  HttpServletRequest request,
    	...
    	try{
            ...
            /*authAppUser.setEnabled(olduser.isEnabled());*/
    ...
    public ModelAndView changeSetting(@PathVariable String libraryPath)throws Exception {
    	Model model = new ExtendedModelMap();
    	super.libraryAndPropertyPass(model, DM_FORM_NAME, libraryPath);
    	model.addAttribute("formEditFlag", true);   
