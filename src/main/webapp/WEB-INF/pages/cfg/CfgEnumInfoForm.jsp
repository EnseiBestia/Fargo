...
<form:hidden path="enumId"/>
    ...
    <div class="form-group">
	        	...
	        	<label class="col-sm-3 col-md-3 col-lg-2 control-label"><fmt:message key="cfgEnumInfo.enumName"/>
	    ...
	    <div class="form-group">
	        	...
	        	<label class="col-sm-3 col-md-3 col-lg-2 control-label"><fmt:message key="cfgEnumInfo.enumCode"/>
						<span class="required"> *</span>		
				</label>
	        <div class="col-sm-9 col-md-9 col-lg-6">
    ...
    <div class="form-group">
	        	...
	        	<label class="col-sm-3 col-md-3 col-lg-2 control-label"><fmt:message key="cfgEnumInfo.constantName"/>
						<span class="required"> *</span>		
				</label>
	        <div class="col-sm-9 col-md-9 col-lg-6">
    ...
    <c:if test="${formEditFlag}">
        ...
        <a href='<c:url value="/lb/${libraryPath}/cfgEnumInfo/list/php?pageGroupType=back"/>' class="btn btn-dark-green">
...
<div class="div_iframe" id="CfgEnumValueInfoOfCfgEnumInfoListDiv">
	...
	<%@ include file="CfgEnumValueInfoList.jsp" %>
	</c:if>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
    	$('#bt-cfgEnumInfo-edit').click(function(){
			...
			ajaxLoadHtmlInDiv($(this),"${ctx}/lb/${libraryPath}/cfgEnumInfo/edit/${cfgEnumInfo.enumId}/php");
    	});
    	
    	$('#bt-cfgEnumInfo-save').click(function(){
    		$(this).attr('disabled',true);
			if(validate_cfgEnumInfoForm.form()){
				ajaxLoadHtmlInDiv($(this),"${ctx}/lb/${libraryPath}/cfgEnumInfo/formSubmit/php","post","cfgEnumInfoForm");
			}else{
        ...
        <c:if test="${!formEditFlag}">
        	...
        	$("#cfgEnumInfoForm textarea").attr("disabled","disabled");
    	</c:if>
