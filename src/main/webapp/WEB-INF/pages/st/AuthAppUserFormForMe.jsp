...
<head>
    <title><fmt:message key="authAppUserDetail.title.modifyMe"/></title>
...
<h2><fmt:message key="authAppUserDetail.title.modifyMe"/></h2>
...
<div class="widget-box">
	<div class="widget-title">
		...
		<h5><fmt:message key="authAppUserDetail.message.modifyMe"/></h5>
	</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
    	$('#bt-authAppUser-edit').click(function(){
			...
			ajaxLoadHtmlInDiv($(this),"${ctx}/lb/${libraryPath}/authAppUser/currentUser/edit/php");
    	});
    	
    	$('#bt-authAppUser-save').click(function(){
    		$(this).attr('disabled',true);
			if(validate_authAppUserForm.form()){
				ajaxLoadHtmlInDiv($(this),"${ctx}/lb/${libraryPath}/authAppUser/currentUser/edit/formSubmit/php","post","authAppUserForm");
			}else{
