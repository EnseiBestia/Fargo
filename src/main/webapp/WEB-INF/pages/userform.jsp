...
<c:choose>
    ...
    <c:when test="${not empty user.username}">
        ...
        <fieldset class="form-actions">
        	...
        	<button type="button" class="btn btn-primary" name="testpost" id="testpost" >
                <i class="icon-ok icon-white"></i> test
            </button>
	...
	$(document).ready(function(){ 
		...
		$('#testpost').click(function() {
			...
			$.ajax({ 
				type: "post", 
				url: $('#userForm').action, 
				data: $('#userForm').serialize()+"&bCancel=false&save=",
...
<appfuse:javascriptValidate formName="user" staticJavascript="false"/>
