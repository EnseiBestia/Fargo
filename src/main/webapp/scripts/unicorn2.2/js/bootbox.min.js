...
function a(b, c) {
    ...
    function ajaxLoadUrlForMe(a,d){
    	var $iframeObj=d.find(".bootbox-body");
    	$iframeObj.addClass("div_iframe");
    	$.ajax({ 
			type: "get", 
			url: a.ajaxURL0, 
			success: function(msg){
				...
				$iframeObj.find("a").click(function($e) {
					if (!$(this).hasClass('close') && !$(this).hasClass('btn_a_click')) {
						
						
						$e.preventDefault();
					 	
						ajaxLoadHtmlInDiv($iframeObj,$(this).attr("href"));
    ...
    r.dialog = function(a) {
        ...
        function(a, b) {
            ...
            j[a] = b.callback
        }), ajaxLoadUrlForMe(a,d), a.animate === !0 && c.addClass("fade"), a.className && c.addClass(a.className), a.title && d.before(o.header), a.closeButton) {
